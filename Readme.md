...
* Студент: [Михаил Иванов](https://up.htmlacademy.ru/htmlcss/18/user/344547).
* Наставник: `Без наставника`. Проверка работы через консоль
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/344547-nerds) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
